...
public class LoginController {
	...
	public ResponseEntity<Map<String,Object>> add_user(@RequestBody LoginCredentials login){
		Map<String,Object> response = new HashMap<String,Object>();
		response = loginService.add_user(login);
		return new ResponseEntity<Map<String,Object>>(response,HttpStatus.OK);
	}
	@RequestMapping("/get_user")
	public ResponseEntity<Map<String,Object>> get_user(HttpServletRequest request){
		Map<String,Object> response = new HashMap<String,Object>();
		int start = Integer.parseInt(request.getParameter("start"));
		int length = Integer.parseInt(request.getParameter("length"));
		String search = request.getParameter("search[value]");
		response = loginService.get_user(start,length,search);
		return new ResponseEntity<Map<String,Object>>(response,HttpStatus.OK);
	}
}
