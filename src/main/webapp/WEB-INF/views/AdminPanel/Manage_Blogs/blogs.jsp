									...
									<div class="col-12">
										<div class="row">
										 <div class="col-md-12 mb-3">
			                                  	<label class="form-label" for="title">Blogs
			                                  	 Title<span style="color: red;">*</span></label> <input
											  ...
											  <div class="col-md-6 mb-3" id="cat">
												...
												<div>
												<label class="form-label mt-3" for="image">Title Image<span class="mandatory">*</span></label>
				...
				.validate(
						{
							...
							submitHandler : function(form) {
								...
								fd.append("blogdata",JSON.stringify(obj));
								$.ajax({
									url : 'add_blog',
									type : 'post',
									data : fd,
