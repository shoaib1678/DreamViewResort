								...
								<div class="col-3">
									<button class="btn btn-secondary btn-sm  add-new btn-primary"
										...
										<span><i class="bx bx-plus me-0 me-sm-1"></i><span
											class="d-none d-sm-inline-block">Cancel Booking</span></span>
									</button>
								</div>
							</div>
							<div class="row p-4">
										...
										<table id="category_table" class="table nowrap"
											...
											<thead class="bg-primary">
												<tr>
													...
													<th class="text-white">Cancellation Charge</th>
													<th class="text-white">Cancellation Date</th>
						...
						<div class="nav-align-top mb-4">
							<div class="row">
								<div class=" col-lg-12 mb-6 mt-1">
									<label class="form-label" for="booking_id">Booking Id<span style="color: red;">*</span></label> <input
										type="text" class="form-control" id="booking_id" placeholder=" "
										name="booking_id" aria-label=" " />
								</div>
								<div class=" col-lg-12 mb-6 mt-1">
									<label class="form-label" for="payment_mode">Payment Mode<span style="color: red;">*</span></label> <input
										type="text" class="form-control" id="payment_mode" placeholder=" "
										name="payment_mode" aria-label=" " disabled/>
								</div>
								<div class=" col-lg-12 mb-6 mt-1">
									<label class="form-label" for="paid_amount">Paid Amount<span style="color: red;">*</span></label> <input
										type="text" class="form-control" id="paid_amount" placeholder=" "
										name="paid_amount" aria-label=" " disabled/>
								</div>
								<div class=" col-lg-12 mb-6 mt-1">
									<label class="form-label" for="can_charge">Cancellation charge<span style="color: red;">*</span></label> <input
										type="text" class="form-control" id="can_charge" placeholder=" "
										name="can_charge" aria-label=" " disabled/>
								</div>
								<div class=" col-lg-12 mb-6 mt-1">
