										...
										<table id="amenities_table" class="table nowrap"
											...
											<thead class="bg-primary">
												<tr>
													...
													<th class="text-white">Amenities Name</th>
						...
						<div class="nav-align-top mb-4">
							<div class="row">
								<div class=" col-lg-12 mb-6 mt-1">
									<label class="form-label" for="amenity_name">Amenity Name<span style="color: red;">*</span></label> <input
										type="text" class="form-control" id="amenity_name" placeholder=" "
										name="amenity_name" aria-label=" " />
								</div>
							</div>
						</div>
					</div>
